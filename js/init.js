$(document).ready(function(){
	...
	$('#mc-form').ajaxChimp({
	    ...
	    url: 'http://twitter.us2.list-manage1.com/subscribe/post?u=a2de53dc82eea9f0b0017f076&id=1294fcc367'
    ...
    $(function () {
	    ...
	    // Date below denotes 23 October, 2014
	    var launchDay = new Date(2014, 10-1, 23);
	    $('#ticker').countdown({
	    	since: launchDay,
